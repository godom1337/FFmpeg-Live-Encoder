...
{
  "jobName": "Test H.265 UDP ABR Stream",
  "inputFile": "$INPUT_FILE",
  "loopInput": true,
  "outputFormat": "udp",
  "outputUrl": "udp://239.1.2.4:5014?ttl=64",
  "videoCodec": "h265",
  "audioCodec": "aac",
  "audioBitrate": "128k",
  ...
  "abrLadder": [
    ...
    },
    {
      ...
      "outputUrl": "udp://239.1.2.5:5015?ttl=64"
    },
    {
      "name": "480p",
      "videoBitrate": "1.2M",
      "videoResolution": "854x480",
      "outputUrl": "udp://239.1.2.6:5016?ttl=64"
    }
  ]
}
EOF
...
echo "  1080p: udp://239.1.2.4:5014"
echo "  720p:  udp://239.1.2.5:5015"
echo "  480p:  udp://239.1.2.6:5016"
echo ""
...
if [ -n "$JOB_ID" ] && [ "$JOB_ID" != "null" ]; then
    ...
    echo "  1080p: ffplay udp://239.1.2.4:5014"
    echo "  720p:  ffplay udp://239.1.2.5:5015"
    echo "  480p:  ffplay udp://239.1.2.6:5016"
else
    echo ""

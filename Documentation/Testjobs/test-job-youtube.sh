...
# Using dummy RTMP URL and Key
JSON_PAYLOAD_CREATE=$(cat <<EOF
{
  "jobName": "YouTube RTMP Stream $(date +%s)",
  "inputFile": "$INPUT_FILE",
  "loopInput": true,
  "outputFormat": "rtmp",
  "outputUrl": "rtmp://a.rtmp.youtube.com/live2/abcd-1234-efgh-5678",
  "rtmpOutputs": [
    {
    ...
    {
      "url": "rtmp://b.rtmp.twitch.tv/app",
      "streamKey": "live_12345_xyz"
    }
  ],
  "videoCodec": "h264",
  "videoBitrate": "5M",

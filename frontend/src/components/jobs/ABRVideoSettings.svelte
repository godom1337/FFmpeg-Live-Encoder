<script>
    /**
     * ABR Video Settings Component
     *
     * Video encoding settings specifically for ABR mode.
     * Replaces VideoSettings when ABR is enabled.
     *
...
<div class="abr-video-settings">
    <h4>📹 Video Settings (ABR Mode)</h4>
    <small class="abr-note">
        Video codec and encoding settings apply to all ABR renditions. Bitrate,
        resolution, and profile are configured per-rendition in the ladder.
    </small>

    <div class="settings-grid">
        <!-- Video Codec -->
        <div class="form-group">
            <label for="abr-video-codec">Video Codec (All Renditions)</label>
            <select
                id="abr-video-codec"
        ...
        <!-- Encoding Preset -->
        <div class="form-group">
            <label for="abr-preset">Encoding Preset</label>
            <select
                id="abr-preset"
        ...
        <!-- FPS -->
        <div class="form-group">
            <label for="abr-fps">Framerate (FPS)</label>
            <input
                id="abr-fps"
                type="number"
                ...
                class="form-control"
            />
            <small class="help-text"> Applies to all renditions </small>
        </div>

        <!-- Video Track Selection -->
        <div class="form-group">
            <label for="abr-video-track">Video Track</label>
            <select
                id="abr-video-track"
    ...
    <div class="form-group full-width">
        <label for="abr-hardware-accel">Hardware Acceleration</label>
        <select
            id="abr-hardware-accel"
    ...
    <!-- Video Filters -->
    <div class="form-group full-width">
        <label for="abr-video-filters">Custom Video Filters</label>
        <input
            id="abr-video-filters"
            type="text"
        ...
        />
        <small class="help-text">
            FFmpeg filter syntax (advanced users). Applied to all renditions.
        </small>
    </div>
</div>
